...
namespace DentalClinicProject
{
    public partial class LoginForm : Form
    {
        ...
        {
            // filling combo with usernames
            cmbUsername.Items.Add("نيروز");
            cmbUsername.Items.Add("د. أحمد علي");
            cmbUsername.Items.Add("ريم");
        ...
        private void btnSighnIN_Click(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                {
                    frm = new AdminDashboardForm(); // داشبورد الأدمن
                }
